...
const ICONS: Record<ProductionSubDepartment, React.ReactNode> = {
  // Scissors / cut — teal + magenta bars
  cutting: (
    <>
  ...
  // Bent angle — teal + orange
  bending: (
    <>
      <path d="M12 46 L12 20 L36 20" stroke="#017E84" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M28 46 L52 46 L52 22" stroke="#F06A26" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" opacity="0.9" />
    </>
  ),

  // Snowflake / cool — cyan + purple
  refrigeration: (
    <>
  ...
  // Syringe / droplet injection — teal + purple
  injection: (
    <>
  ...
  // Cold sheet — blue tones
  sheet_metal_cold: (
    <>
      <rect x="10" y="22" width="44" height="28" rx="4" fill="#5B7FC7" opacity="0.35" />
      <rect x="14" y="16" width="44" height="28" rx="4" fill="#017E84" />
      <path d="M24 28 L28 36 L36 22" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" opacity="0.7" />
    </>
  ),

  // Hot sheet — orange / red
  sheet_metal_hot: (
    <>
      <rect x="10" y="22" width="44" height="28" rx="4" fill="#F06A26" opacity="0.35" />
      <rect x="14" y="16" width="44" height="28" rx="4" fill="#E05A3C" />
      <path d="M26 36 C28 28 32 26 32 26 C32 26 36 28 38 36" stroke="#F3CC45" strokeWidth="3" strokeLinecap="round" fill="none" />
    </>
  ),

  // Anvil / hammer — purple + orange (manufacturing-like bars)
  blacksmithing: (
    <>
  ...
  // Kitchen / stove — teal + yellow + orange bars like Odoo Manufacturing
  kitchens: (
    <>
