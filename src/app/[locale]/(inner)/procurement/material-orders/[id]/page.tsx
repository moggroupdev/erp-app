...
import MaterialPurchaseOrderPrintDocument from "@/components/documents/procurement/mpos/material-purchase-order-print-document";
...
export default function Page() {
  ...
  const {
    ...
    enabled: canReadSupplierInvoices,
  });

  const isFetching = isOrderFetching || isReceiptsFetching || (canReadSupplierInvoices && isInvoicesFetching);

  function refetch() {
    refetchOrder();
    refetchReceipts();
    if (canReadSupplierInvoices) refetchInvoices();
  }
