  ...
  return (
    ...
    >
      ...
      <Modal
        ...
        title={translate("Confirm create requisition", "تأكيد إنشاء الطلب")}
      >
        <div className="flex flex-col gap-3">
          <p className="text-sm text-gray-600">
            {translate(
              "Are you sure you want to create this material purchase requisition?",
              "هل أنت متأكد من إنشاء طلب شراء الخامات هذا؟",
            )}
          </p>
