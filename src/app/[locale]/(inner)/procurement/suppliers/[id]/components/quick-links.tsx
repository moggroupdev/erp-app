  ...
  return (
    <section className="mt-4 flex flex-col gap-3">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <Link
          href={getLocalizedHref(`/reports/purchasing-materials/supplier-stats?supplierId=${supplierId}`)}
          ...
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="flex flex-col gap-1.5">
              <span className="text-sm font-semibold text-gray-900 group-hover:text-blue-800">
                {translate("Purchasing by Supplier", "المشتريات حسب المورد")}
              </span>
              <span className="text-xs text-gray-500">
                {translate("View purchase stats for this supplier", "عرض إحصائيات المشتريات لهذا المورد")}
              </span>
            </div>
          </div>
