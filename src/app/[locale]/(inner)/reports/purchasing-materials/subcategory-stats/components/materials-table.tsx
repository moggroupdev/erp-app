...
import type { SubCategoryMaterialsSort } from "./sort";

const BASE_UNIT_VALUE = "__base__";

export default function SubCategoryMaterialsTable({
  data,
  sort,
  onSortChange,
  displayUnit,
  ...
  sort: SubCategoryMaterialsSort;
  onSortChange: (sort: SubCategoryMaterialsSort) => void;
  ...
  return (
    <ReportCard
      ...
      description={translate(
        "All materials purchased within this subcategory.",
        "جميع المواد المشتراة ضمن هذه الفئة الفرعية.",
      )}
      icon={Boxes}
      accent="sky"
      headerAction={
        <div className="flex flex-wrap items-end justify-end gap-2">
          ...
          <Select
            value={sort}
            onChange={(value) => {
              if (value) onSortChange(value as SubCategoryMaterialsSort);
            }}
