            ...
            <table className="w-full table-fixed border-collapse text-[8.5px]">
              <thead>
                <tr className="border-b border-gray-300 bg-gray-50 text-[7.5px] font-medium tracking-wide text-gray-500 uppercase">
                  <th className="w-[11%] px-2.5 py-2 text-start whitespace-nowrap">{translate("Material Code", "كود")}</th>
                  <th className="w-[22%] px-2.5 py-2 text-start whitespace-nowrap">{translate("Material Name", "الصنف")}</th>
                  <th className="w-[11%] px-2.5 py-2 text-start whitespace-nowrap">{translate("Category", "الفئة")}</th>
                  <th className="w-[8%] px-2.5 py-2 text-start whitespace-nowrap">{translate("Unit", "الوحدة")}</th>
                  <th className="w-[8%] px-2.5 py-2 text-start whitespace-nowrap">{translate("Quantity", "الكمية")}</th>
                  <th className="w-[10%] px-2.5 py-2 text-start whitespace-nowrap">
                    ...
                    <tr key={item.id} className="border-b border-gray-200">
                      <td className="px-2.5 py-2">
                        <div className="flex items-center gap-1.5">
                          <span className="font-mono text-[10px] text-gray-600">{item.material.code}</span>
              ...
              <tfoot>
                <tr className="border-t border-gray-300 bg-gray-50 font-medium">
                  ...
                  <td colSpan={5} className="px-2.5 py-2 text-gray-600">
            ...
            <tbody>
              {manufacturingRows.map((row) => (
                <tr key={row.id} className="border-b border-gray-200">
                  <td className="px-2.5 py-2">
                    <div className="flex items-center gap-1.5">
                      <span className="font-mono text-[10px] text-gray-600">{row.materialCode}</span>
